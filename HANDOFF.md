...
> 面向接手这个项目的人。写于 2026-09-18，随阶段推进持续更新。对外介绍见 `README.md`；未来计划见 `ROADMAP.md`；配套阅读：`PLAN.md`（带勾选的活计划，含每个里程碑的验收标准与实施备注）。
...
| 阶段7 | 复习优化第二批：周次过滤、待确认批量确认、上次看到标记、大图堂数显示、导出带标注图（单测共 43 个）；OCR 搜索（M7）待启动 | ✅ |
