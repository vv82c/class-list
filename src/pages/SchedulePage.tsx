            ...
            >
              ...
              {layoutDay(byDay[di]).map((b, i) => (
                <Link
                  ...
                  className="absolute overflow-hidden rounded-md p-1 text-sm font-medium leading-tight text-white shadow-sm"
                  style={{
                ...
                >
                  {b.slot.course.name}
                  <br />
                  {slotToString(b.slot.startMin)}-{slotToString(b.slot.endMin)}
